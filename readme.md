...
| 15 - LocalStorage                                  | Aug 31, 2020 | CSS: Custom checkbox.<br>JS: Local storage, event delegation ("responsible parents, negligent children"). Challenge: add uncheck/check all and clear list buttons. That's in the works... |
